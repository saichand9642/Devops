...
/** The questions that come up in almost every splunk round. */
export const splunkCoreQuestions: InterviewQuestion[] = [
  {
    id: 'itv-splunk-1',
    level: 'basic',
    kind: 'open',
...
| tstats count WHERE index=prod sourcetype=app BY host, _time span=1h`,
  ...
  },
  {
    ...
    level: 'intermediate',
    kind: 'open',
    prompt: 'Explain index-time versus search-time field extraction. Which do you prefer and why?',
    probing:
...
FORMAT = nullQueue`,
  ...
  },
  {
    ...
    probing: 'Practical SPL fluency. They want to see pipeline thinking and correct use of stats.',
    answer: [

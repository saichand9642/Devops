...
/** The questions that come up in almost every linux round. */
export const linuxCoreQuestions: InterviewQuestion[] = [
  {
    id: 'itv-linux-1',
    level: 'basic',
    kind: 'mcq',
...
status=timeout        did not signal readiness within TimeoutStartSec
  ...
  },
  {
    ...
    probing: 'Network troubleshooting methodology. They want to see you bisect rather than guess.',
    answer: [

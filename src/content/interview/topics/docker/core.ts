...
/** The questions that come up in almost every docker round. */
export const dockerCoreQuestions: InterviewQuestion[] = [
  {
    id: 'itv-docker-1',
    level: 'basic',
    kind: 'open',
    ...
    code: [
      {
        ...
        language: 'dockerfile',
        explanation: 'Both produce the same running image. One is about 40 MB larger, permanently.',

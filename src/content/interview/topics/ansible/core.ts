...
/** The questions that come up in almost every ansible round. */
export const ansibleCoreQuestions: InterviewQuestion[] = [
  {
    id: 'itv-ansible-1',
    level: 'basic',
    kind: 'open',
...
# failure taints the resource. Use Ansible, or bake an image with Packer.`,
  ...
  },
  {
    ...
    probing: 'Real orchestration: serial batches, load balancer coordination, and failing safely.',
    answer: [

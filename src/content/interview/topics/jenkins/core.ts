...
/** The questions that come up in almost every jenkins round. */
export const jenkinsCoreQuestions: InterviewQuestion[] = [
  {
    id: 'itv-jenkins-1',
    level: 'basic',
    kind: 'open',
  ...
  },
  {
    ...
    probing: 'Whether you understand pipeline-as-code as a practice rather than a Jenkins feature.',
    answer: [
